...
use Atlas\DDD\Secretariat\Features\RegisterInstitution\UniqueIdentifier;
...
final class Institution implements JsonSerializable
{
    ...
    public function __construct(UniqueIdentifier $institutionId, string $name, string $country)
    {
        $this->id = $institutionId->toString();
        $this->name = $name;
